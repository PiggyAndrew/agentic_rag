...
export function Viewer(data, parent, width, height, callback) {
    ...
    loader.load('../fonts/zhongsong_regular.typeface.json', function (response) {
        ...
        var renderer = new THREE.WebGLRenderer({ antialias: true, devicePixelRatio: pixelRatio });
...
export function highlightObject(object) {
    ...
    object.material.color.set(0xff0000); // 设置为红色
}
...
export function drawEntity(entity, data, font, scene) {
    ...
    if (entity.type === 'CIRCLE' || entity.type === 'ARC') {
        ...
        mesh = drawLine(entity, data,scene);
...
export function drawLine(entity, data,scene) {
